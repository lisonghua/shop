...
@Controller
public class PCPaymentController {
	...
	@RequestMapping(value = "pc/payment",method = RequestMethod.GET)
	public ModelAndView payment(@Valid Order order, HttpServletRequest req) throws ApiServiceException {
		...
		modelAndView.setViewName("pc/payment");
		return modelAndView;
	}

	@RequestMapping(value = "pc/payment/order",method = RequestMethod.POST)
	@ResponseBody
