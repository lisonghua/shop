...
<body class="smoothscroll enable-animation">
							...
							<div class="shop-item">
								<div class="thumbnail">
									...
									<a class="shop-item-image" href="${root}/pc/product/${product.id}">
										<img class="img-responsive" src="${root}${product.defaultImg}"/>
									</a>
									<!-- /product image(s) -->
									<!-- hover buttons -->
	...
	//bao'wen
		$(document).ready(function(){
			$('[name="bootpagFooter"]').bootpag({
			   total: '${productListPage.totalPage}',
			   page: '${productListPage.currentPage}',
			   maxVisible: '${productListPage.pageSize}',
			   leaps: false,
			   next: '>',
			   prev: '<'
			}).on('page', function(event, num) {
				window.location.href = '${root}/pc/category/${categoryObject.id}/page/' + num;
			});
		});
	</script>
</body>
