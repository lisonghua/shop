					...
					<div class="panel-body">
						<div class="hpanel">
							<ul class="nav nav-tabs">
								...
								<li class=""><a id="liOption" data-toggle="tab" href="#tab-2">商品Option</a></li>
							</ul>
									...
									<form:form modelAttribute="product" id="form_productInfo" name="form_productInfo" method="POST">
										...
										<div class="row" style="padding:20px">
											...
											<div class="row">
												<div class="form-group col-lg-6">
													...
													<div>
														<label>
															<input type="radio" value="0" class="i-checks" name="inventoryFlag" <c:if test="${product.inventoryFlag==0}">checked</c:if>>&nbsp;&nbsp;是</label>&nbsp;&nbsp;
														<label>
															<input type="radio" value="1" class="i-checks" name="inventoryFlag" <c:if test="${product.inventoryFlag==1}">checked</c:if>>&nbsp;&nbsp;否</label>
													</div>
												</div>
												<div class="form-group col-lg-6">
													<label>是否热销</label>
													<div>
														<label>
															<input type="radio" value="0" class="i-checks" name="hot" <c:if test="${product.hot==0}">checked</c:if>>&nbsp;&nbsp;非热门商品</label>&nbsp;&nbsp;
														<label>
															<input type="radio" value="1" class="i-checks" name="hot" <c:if test="${product.hot==1}">checked</c:if>>&nbsp;&nbsp;热门商品</label>
													</div>
												</div>
											</div>
											<div class="row">
														...
														<div id="imageFile">
															<div id="DB_WU_FILE_0" style="float:left" class="file-item thumbnail">
																...
																<div style="padding-top: 2px">
																	<button class="btn btn-default btn-sm" type="button" onclick="deleteImage(this)">删除</button>
																</div>
											...
											<div class="form-group col-lg-12">
												...
												<div style="width: auto;height: auto;">
													...
													<!-- 配置文件 -->
													<script src="${pageContext.request.contextPath}/resources/admin/js/ueditor/ueditor.config.js" type="text/javascript"></script>
													<!--　编辑器源码文件 -->
													<script src="${pageContext.request.contextPath}/resources/admin/js/ueditor/ueditor.all.js" type="text/javascript" ></script>
													<!--　实例化编辑器 -->
										...
										<div class="row" style="padding:20px">
											<div class="text-left m-t-xs">
												<button id="saveProductInfo" class="btn btn-success" style="margin-right: 5px;margin-top: 5px" type="button">
													<strong>保存</strong>
												</button>
												<button id="back" class="btn btn-success" style="margin-right: 5px;margin-top: 5px" type="button">
													<strong>返回</strong>
												</button>
											</div>
										</div>
							...
							<c:forEach items="${optionList}" var="item">
								<div class="input-group">
									<div class="checkbox checkbox-success">
										<input type="checkbox" name="optionId" value="${item.id}">
										<label>${item.name}</label>
									</div>
								</div>
							</c:forEach>
						</div>
						<button id="createSkuBtn" class="btn btn-success" type="button" >生成SKU</button>
						<button id="deleteSkuBtn" class="btn btn-success" type="button" >清除SKU</button>
				</div>
			</div>
			<div class="col-md-9">
				<div class="hpanel">
...
<div class="panel-body" data-key="${item.optionValueKeyGroup}" >
	<h4>${item.skuJson}</h4>
	<div class="form-group">
		<label class="col-sm-2 control-label">价格</label>
		<div class="col-sm-10">
			<input type="text" name="price" class="form-control priceTouchSpin" value="${item.price / 100}">
			<input type="hidden" name="key" value="${item.optionValueKeyGroup}">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label">库存</label>
		<div class="col-sm-10">
			<input type="text" name="quantity" class="form-control quantityTouchSpin" value="${item.quantity}">
		</div>
	</div>
	<div class="form-group">
		<div class="col-sm-8 col-sm-offset-2">
			<button class="btn btn-default" onclick="delMoreRow('${item.optionValueKeyGroup}')">删除</button>
		</div>
	</div>
</div>
							</c:forEach>
