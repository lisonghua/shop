					...
					<div class="row">
								<div id="error_div" class="text-left"></div>
									<form:form modelAttribute="product" id="form_productInfo" name="form_productInfo" method="POST">
										...
										<div class="form-group col-lg-6">
											<label>热门商品</label>
					                        <br><input type="radio" value="0" class="i-checks" name="XXXX">&nbsp;&nbsp;非热门商品
					                        &nbsp;&nbsp;<input type="radio" value="1" class="i-checks" name="XXXX">&nbsp;&nbsp;热门商品
					                        &nbsp;&nbsp;<input type="radio" value="2" class="i-checks" name="XXXX" checked>&nbsp;&nbsp;全部
