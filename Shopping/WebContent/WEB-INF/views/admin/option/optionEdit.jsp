							...
							<div class="hpanel">
								...
								<form id="form_option" name="form_option" action='' method="POST">
									...
									<div class="form-group col-lg-12">
										<label class="col-sm-3 control-label">option名称</label>
										<div class="col-sm-9">
											<input type="text" id="name" name="name" class="form-control" maxlength="50" placeholder="option名称" value='${option.name}' />
									...
									<div id="opionValueDiv">									
										<c:forEach items="${option.optionValue}" var="item" varStatus="status">
										    <div class="form-group col-lg-12"><label class="col-sm-3 control-label">Option Value</label>
...
//                 }                                   
	...
	$("#addOptionValueButton").click(function() {
		var optionValueInput = '<div class="form-group col-lg-12"><label class="col-sm-3 control-label">Option Value</label>';
			optionValueInput+='<div class="col-sm-6"><input type="text" name="optionValue" class="form-control" maxlength="50" placeholder="option Value"/></div>';
	    		...
	    		$.ajax({
	    			...
	    			success : function(json) {
	    				...
	    				for(i in json.data.optionValue){
	    					var optionValueInput = '<div class="form-group col-lg-12"><label class="col-sm-3 control-label">Option Value</label>';
	    					optionValueInput+='<div class="col-sm-6"><input type="text" name="optionValue" class="form-control" maxlength="50" placeholder="option Value" value="'+json.data.optionValue[i].name+'"/></div>';
