...
<script type="text/javascript" src="${root}/resources/mobile/vue.min.js"></script>
<script type="text/javascript" src="${root}/resources/mobile/axios.min.js"></script>
</head>
			...
			<div class="page__bd" style="height: 100%;">
				<div class="weui-tab">
					<div class="weui-tab__panel" style='padding-bottom: 100px'>
						...
						<div id="prod">
   						<prod_list v-for="e in wares" :category="e"></prod_list>
    					</div>
					</div>
...
<script>
	Vue.component('prod_list',{
    props:['category'],
    template:`
	    <div class='weui-panel weui-panel_access'>
	        <div class="weui-panel__hd">{{category.name}}</div>
	        <div class="weui-panel__bd" v-for="product in category.productRelationList" >
	            <a :href="['/mobile/mobile/product/'+product.id]" class="weui-media-box weui-media-box_appmsg">
	                <div class="weui-media-box__hd">
	                    <img :src="'/Shopping'+product.defaultImg" class="weui-media-box__thumb" /> 
	                </div>
	        ...
	        <div class="weui-panel__ft">
	            <a href="{{ctx_path}}/mobile/category/{{category.id}}" class="weui-cell weui-cell_access weui-cell_link">
	...
	`
      ...
      var app=new Vue({
       ...
       methods:{
    	   qc:function(){
              	var url=this.ctx_path+'/mobile/query_category';
              	console.log(url)
              	var w=this;
              	console.log("w is:"+w);
